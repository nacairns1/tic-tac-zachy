		...
		<div className="h-full">
			...
			<div className="h-80 flex flex-col md:flex-row justify-center items-center gap-10">
					<Link href="/games/tic-tac-toe/local">
						<button className="btn btn-primary btn-xl h-1/2 rounded-3xl">Play Tic-Tac-Toe Offline!</button>
					</Link>
					<button className="btn btn-secondary btn-xl h-1/2 rounded-3xl">Play Tic-Tac-Toe Online!</button>
			</div>
		</div>
	);
}
